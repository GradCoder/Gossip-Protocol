...
start() ->
    ...
    case Topology of
        "2D" -> if Algorithm=="Gossip" -> gossip_exec:gossip_2d(Nodes,Nodes); true -> gossip_exec:pushsum_2d(Nodes) end;
        "FULL" -> if Algorithm=="Gossip"-> gossip_exec:gossip_full(Nodes,Nodes); true -> gossip_exec:pushsum_full(Nodes) end;
